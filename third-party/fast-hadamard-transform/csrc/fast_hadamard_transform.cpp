...
at::Tensor
faster_fast_hadamard_transform(at::Tensor &x, float scale, at::Tensor &out) {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("faster_fast_hadamard_transform", &faster_fast_hadamard_transform, "Faster Fast Hadamard transform");
