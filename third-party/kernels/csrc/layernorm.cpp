...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("rms_norm_general_fuse_sum_i4", &rms_norm_general_fuse_sum_i4, py::arg("out"), py::arg("input"),
        // py::arg("weight"), 
        py::arg("input_sum"), py::arg("scaling"), py::arg("epsilon"), py::arg("use_per_token_quant") = false,
        "Apply Root Mean Square (RMS) Normalization to the input tensor & get input sum (TRTLLM kernel).");

  m.def("rms_norm_general_fuse_sum_fp16", &rms_norm_general_fuse_sum_fp16, py::arg("out"), py::arg("input"),
      py::arg("epsilon"),
      "Apply Root Mean Square (RMS) Normalization to the input tensor & get input sum (TRTLLM kernel).");

  m.def("rms_norm_general_fuse_sum_i8", &rms_norm_general_fuse_sum_i8, py::arg("out"), py::arg("input"),
        // py::arg("weight"), 
        py::arg("input_sum"), py::arg("scaling"), py::arg("epsilon"), py::arg("use_per_token_quant") = false,
        "Apply Root Mean Square (RMS) Normalization to the input tensor & get input sum (TRTLLM kernel).");
